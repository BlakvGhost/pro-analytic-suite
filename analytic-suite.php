<?php
/**
 * Plugin Name: Entourage Lite Plugin
 * Description: Plugin analytics premium pour suivre les ventes WooCommerce, réservations FluentBooking, contenus.
 * Version: 0.1.0
 * Author: CYBERKA
...
define( 'ANALYTIC_SUITE_VERSION', '0.1.0' );
